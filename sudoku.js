function Board(length) {
	...
	this.length = length;
	this.regions = makeRegions(width);
	...
	function makeRegions(length) {
		...
		this.makeRegionCorners(length, regions);
	...
	function makeRegionCorners(length, regions){
		var count = 0;
	...
	this.makeRegionSpaces = function(section, direction){
	...
	this.solveGame = function(grid, r, c, regNum) {
